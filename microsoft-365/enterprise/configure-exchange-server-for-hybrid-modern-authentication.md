...
> [!NOTE]
> Outlook Web App and Exchange Control Panel does not work with hybrid Modern Authentication.  In addition, publishing OWA/ECP via Azure Web Application Proxy is not supported.
